...
資料科學最大的迷思是「儘管品質很差，只要有很多資料還是可以分析」。這代表不管數據精確到小數第幾位、偵測器有沒有失靈、或名字有沒有被打錯，只要資料夠多就能彌補這些問題。雖然我們確實可以利用拼字檢查等工具修正錯字，或是在某些情況下去除資料中無法避免的雜訊，但我們無法輕易解決粗心大意所導致的問題。這些問題會影響整個資料，讓我們更難從中找出規律。通常對資料科學家來說，少量的高品質資料反而比大量劣質資料還有價值。
