...
为了理解 LSTM 的运作原理，我们可以考虑一下「晚餐要吃什么」这个问题：假设读者住在公寓，很幸运地有个爱煮晚餐的室友。每天晚上室友都会准备寿司、松饼或披萨，而你希望能预测某个晚上你会吃什么，并借此规划其他晚餐。为了预测晚餐，你建了一个神经网络模型。这个模型的输入数据报括星期几、第几个月、以及室友是否开会开到很晚等会影响晚餐的因素。
